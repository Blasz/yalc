...
var copyFile = function(srcPath, destPath, relPath) {
  ...
  return __awaiter(_this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fs.copy(srcPath, destPath)]
        case 1:
          _a.sent()
...
exports.copyPackageToStore = function(pkg, options) {
  return __awaiter(_this, void 0, void 0, function() {
    var workingDir,
      copyFromDir,
      storePackageStoreDir,
      ignoreFileContent,
      ignoreRule,
      npmList,
      filesToCopy,
    ...
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          ...
          storePackageStoreDir = path_1.join(
            _2.getStorePackagesDir(),
            pkg.name,
            pkg.version
          )
        ...
        case 1:
          npmList = _b.sent()
          filesToCopy = npmList.filter(function(f) {
            return !ignoreRule.ignores(f)
          })
          if (options.files) {
          ...
          copyFilesToStore = function() {
            return __awaiter(_this, void 0, void 0, function() {
              return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return [4 /*yield*/, fs.remove(storePackageStoreDir)]
                  case 1:
                    _a.sent()
                    return [
                      2 /*return*/,
                      Promise.all(
                        filesToCopy.sort().map(function(relPath) {
                          return copyFile(
                            path_1.join(copyFromDir, relPath),
                            path_1.join(storePackageStoreDir, relPath),
                            relPath
                          )
                        })
                      )
        ...
        case 2:
          ...
          return [3 /*break*/, 5]
        case 3:
          return [4 /*yield*/, copyFilesToStore()]
        case 4:
          _a = _b.sent()
          _b.label = 5
        case 5:
