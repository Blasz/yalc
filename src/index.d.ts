...
export declare const getPackageStoreDir: (
  packageName: string,
  version?: string
) => string
...
export declare const getPackageManagerInstallCmd: (
  cwd: string
) => 'yarn' | 'npm install'
export declare const execLoudOptions: ExecSyncOptions
export declare const parsePackageName: (
  packageName: string
) => {
  name: PackageName
  version: string
}
export declare function readPackageManifest(
  workingDir: string
...
export declare const writeSignatureFile: (
  workingDir: string,
  signature: string
) => void
export declare function writePackageManifest(
  workingDir: string,
  pkg: PackageManifest
): void
export declare const isYarn: (cwd: string) => boolean
export declare const runOrWarnPackageManagerInstall: (
  workingDir: string,
  doRun?: boolean | undefined
) => void
