...
exports.addPackages = function(packages, options) {
  return __awaiter(_this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          if (!packages.length) return [2 /*return*/]
          ...
          doPure =
            options.pure === false
              ? false
              : options.pure || !!localPkg.workspaces
          addedInstallsP = packages.map(function(packageName) {
            return __awaiter(_this, void 0, void 0, function() {
              var _a,
                name,
                _b,
              ...
              return __generator(this, function(_c) {
                switch (_c.label) {
                  case 0:
                    ;(_a = _1.parsePackageName(packageName)),
                      (name = _a.name),
                      (_b = _a.version),
                    ...
                    storedPackageDir = _1.getPackageStoreDir(
                      name,
                      versionToInstall
                    )
                    ...
                    destYalcCopyDir = path_1.join(
                      workingDir,
                      _1.values.yalcPackagesFolder,
                      name
                    )
                    storeCache = {}
                    return [
                      4 /*yield*/,
                      sync_dir_1.copyDirSafe(
                        storedPackageDir,
                        destYalcCopyDir,
                        storeCache
                      )
                    ...
                    if (doPure) {
                      ...
                      console.log(
                        pkg.name +
                          ...
                          pkg.version +
                          ' added to ' +
                          path_1.join(_1.values.yalcPackagesFolder, name) +
                          ' purely'
                      )
                    }
                    if (!!doPure) return [3 /*break*/, 5]
                    destModulesDir = path_1.join(
                      workingDir,
                      'node_modules',
                      name
                    )
                  ...
                  case 4:
                    if (!options.link) {
                      ...
                      if (whereToAdd[pkg.name] !== localAddress) {
                        replacedVersion =
                          replacedVersion || whereToAdd[pkg.name]
                        whereToAdd[pkg.name] = localAddress
                        localPkg.dependencies =
                          whereToAdd === dependencies
                            ? dependencies
                            : localPkg.dependencies
        ...
        case 1:
          ...
          lockfile_1.addPackageToLockfile(
            addedInstalls.map(function(i) {
              return {
                name: i.name,
                version: i.version,
                replaced: i.replaced,
