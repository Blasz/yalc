...
export declare const removeLockfile: (
  options: {
    workingDir: string
  }
) => void
export declare const readLockfile: (
  options: {
    workingDir: string
  }
) => LockFileConfigV1
export declare const writeLockfile: (
  lockfile: LockFileConfigV1,
  options: {
    workingDir: string
  }
) => void
export declare const addPackageToLockfile: (
  packages: ({
    name: string
