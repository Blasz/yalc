...
export declare const showInstallations: (
  {
    packages
  }: {
    packages: string[]
...
export declare const cleanInstallations: (
  {
    packages,
    dry
  }: {
...
export declare const saveInstallationsFile: (
  installationsConfig: InstallationsFile
) => Promise<void>
export declare const addInstallations: (
  installations: PackageInstallation[]
) => Promise<void>
export declare const removeInstallations: (
  installations: PackageInstallation[]
) => Promise<void>
