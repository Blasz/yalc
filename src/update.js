    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          if (packages.length) {
            packages.forEach(function(packageName) {
              var _a = _1.parsePackageName(packageName),
                name = _a.name,
                version = _a.version
          ...
          lockPackages = packagesToUpdate.map(function(name) {
            return {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            _1.addPackages(packagesLinkDep, {
              workingDir: options.workingDir,
              linkDep: true,
              pure: false,
              yarn: false
        ...
        case 4:
          ...
          for (_i = 0, packages_1 = packages; _i < packages_1.length; _i++) {
            ...
            if (postupdate) {
              console.log(
                'Running postupdate script of package ' +
                  packageName +
                  ' in ' +
                  workingDir
              )
        ...
        case 5:
          ...
          _a.label = 6
        case 6:
          return [2 /*return*/, installationsToRemove]
      }
    })
  })
}
