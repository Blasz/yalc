    ...
    return __generator(this, function(_e) {
      switch (_e.label) {
        ...
        case 1:
          return [
            4 /*yield*/,
            globP('**', { cwd: srcDir, ignore: ignore, dot: dot, nodir: nodir })
          ]
        case 2:
          _a = _e.sent()
          _e.label = 3
        ...
        case 4:
          ...
          newFiles = srcList.filter(function(file) {
            return !destMap[file]
          })
          filesToRemove = destList.filter(function(file) {
            return !srcMap[file]
          })
          commonFiles = srcList.filter(function(file) {
            return destMap[file]
          })
        ...
        case 5:
          ...
          _e.label = 6
        case 6:
          return [4 /*yield*/, commonFiles_1.next()]
        case 7:
          if (!((commonFiles_1_1 = _e.sent()), !commonFiles_1_1.done))
            return [3 /*break*/, 14]
        ...
        case 16:
          ...
          if (
            !(
              commonFiles_1_1 &&
              !commonFiles_1_1.done &&
              (_d = commonFiles_1.return)
            )
          )
            return [3 /*break*/, 18]
        ...
        case 21:
          ...
          return [
            4 /*yield*/,
            Promise.all(
              newFiles.concat(filesToReplace).map(function(file) {
                return fs.copy(
                  path_1.resolve(srcDir, file),
                  path_1.resolve(destDir, file)
                )
              })
            )
          ]
        case 22:
          ...
          return [
            4 /*yield*/,
            Promise.all(
              filesToRemove.map(function(file) {
                return fs.remove(path_1.resolve(destDir, file))
              })
            )
          ]
        case 23:
